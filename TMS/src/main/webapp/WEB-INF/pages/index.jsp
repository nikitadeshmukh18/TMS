...
<html lang="en">
  <head>
    ...
    <link href="<%=request.getContextPath()%>/static/css/docs.css" rel="stylesheet">
    <link href="<%=request.getContextPath()%>/static/css/prettify.css" rel="stylesheet">
...
<div class="jumbotron masthead">
  <div class="container">
    ...
    <script src="<%=request.getContextPath()%>/static/js/bootstrap-affix.js"></script>

    <script src="<%=request.getContextPath()%>/static/js/holder.js"></script>
    <script src="<%=request.getContextPath()%>/static/js/prettify.js"></script>
